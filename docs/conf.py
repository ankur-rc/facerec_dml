...
# import os
# import sys
# sys.path.insert(0, u'/media/ankurrc/new_volume/softura/facerec/code/face-trigger/face_trigger')
...
htmlhelp_basename = 'face_triggerdoc'
...
texinfo_documents = [
    (master_doc, 'face_trigger', u'face_trigger Documentation',
     author, 'face_trigger', 'One line description of project.',
     'Miscellaneous'),
]
